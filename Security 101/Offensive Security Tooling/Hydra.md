...
- [47. John the Ripper — Hash Cracking in Practice](./47-john-the-ripper-hash-cracking-in-practice.md)
- [49. Web Application Fundamentals & HTTP Security Headers](./49-web-application-fundamentals-http-security-headers.md)
- [50. JavaScript Fundamentals for Web Security](./50-javascript-fundamentals-for-web-security.md)
